      ...
      <Container maxWidth="lg">
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Box>
              <IconButton aria-label="Facebook" sx={{ color: "#5D4037" }}>
                <Facebook />
              </IconButton>
              <IconButton aria-label="Instagram" sx={{ color: "#5D4037" }}>
                <Instagram />
              </IconButton>
              <IconButton aria-label="Twitter" sx={{ color: "#5D4037" }}>
                <Twitter />
              </IconButton>
            </Box>
          </Grid>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
              ...
              <Typography variant="body2">Sfax, Route Gremda Km 10</Typography>
            </Box>
            <Box sx={{ display: "flex", alignItems: "center", mb: 1 }}>
          ...
          <Grid item xs={12} md={4}>
            ...
            <Link href="/panier" color="inherit" display="block" sx={{ mb: 1 }}>
            ...
            {!isMobile && (
              <Link
                ...
                sx={{ mb: 1 }}
              >
                <Typography variant="body2">Espace Admin</Typography>
              </Link>
            )}
          </Grid>
        </Grid>
